...
<body>
	...
	<div class="nav">
		...
		<div class="body">
				...
				<div class="row">
					<form class="form-horizontal col-md-7 column" role="form">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" disabled="disabled"  value="${cus.username }" />
							</div>
						</div>
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">收货地址：</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" disabled="disabled"  value="${cus.address }" />
							</div>
						</div>
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">收货人电话：</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" disabled="disabled"  value="${cus.phone }" />
							</div>
						</div>
					</form>
				</div>
				...
				<c:forEach items = "${shopCar }" var = "car">
                    <div class="twoDiv row">
						...
						<div class="col-md-9  column order-message">
							<div class="row"> 
								<font class="col-md-3  column"  color="red" size="3">${car.book.name }</font>
								<font class="col-md-3  column">¥ ${car.book.price }</font>
								<font class="col-md-3  column">×${car.num }</font>
			...
			<div class="allButtom">
				<p class="caozuo">
					<a href="alipay?num=${param.num}&price=${param.price}">订单确认</a>
				</p>
				<span>共<font id="book-num" style="color: #b11e22;">${param.num }</font>件商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;应付：¥<font
					id="price-sum" style="color: #b11e22;">${param.price }</font>元
				</span>
			</div>
		</div>
