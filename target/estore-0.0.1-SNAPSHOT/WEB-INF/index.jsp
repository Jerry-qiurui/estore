			...
			<div class="col-md-6 column">
				<div class="input-group search">
					<input type="text" id="bookname" class="form-control"
						...
						<button class="btn btn-estore" type="button"
							onclick="searchbook()">
	...
	<div class="body">
			...
			<div class="col-md-2 column menu">
				<ul>
					<c:forEach items="${categories }" var="map">
						<li href="#${map.key }" data-toggle="collapse"><span
							class="glyphicon glyphicon-tags"></span>${map.key }</li>
						<div id="${map.key }" class="collapse on">
							<div class="collapse-body">
								<c:forEach items="${map.value}" var="category">
									<a href="searchBook?category_id=${category.id }">${category.name }</a>
								</c:forEach>
							</div>
						</div>
					</c:forEach>
			...
			<div class="col-md-2 column message">
				<div class="row">
					...
					<div class="col-md-8 column">
						...
						<c:if test="${empty sessionScope.cus}">
							<p>
								<a href="toLogin">登录</a>|<a href="toRegister">注册</a>
							</p>
						</c:if>
					</div>
					<div class="col-md-8 column">
		...
		<div class="row miaosha">
			...
			<div class="col-md-2 column book">
				<a href="viewBook.html"> <img src="images/book_index/book6.jpg">
				</a>
				<div class="price">
			...
			<div class="col-md-2 column book">
				<a href="viewBook.html"> <img src="images/book_index/book10.jpg">
				</a>
				<div class="price">
					<span class="price-one">119.0</span><span class="price-two">79.0</span>
				</div>
			...
			<div class="col-md-2 column book">
				<a href="viewBook.html"> <img src="images/book_index/book9.jpg">
				</a>
				<div class="price">
					<span class="price-one">119.0</span><span class="price-two">79.0</span>
				</div>
			...
			<div class="col-md-2 column book">
				<a href="viewBook.html"> <img src="images/book_index/book8.jpg">
				</a>
				<div class="price">
					<span class="price-one">119.0</span><span class="price-two">79.0</span>
				</div>
			...
			<div class="col-md-2 column book">
				<a href="viewBook.html"> <img src="images/book_index/book7.jpg">
				</a>
				<div class="price">
					<span class="price-one">119.0</span><span class="price-two">79.0</span>
				</div>
				...
				<div class="col-md-3 onebook">
					...
					<div class="row">
						<a href="javascript:void(0);"
							onclick="AddShopCar('${cus.username }',${book.id })">
							<button class="btn btn-shopCar">加入书包</button>
						</a> <a href="confirm.html" class="btn btn-estore">立即购买</a>
					</div>
				</div>
			</c:forEach>
		</div>
